...
function computeMetrics() {
    Object.values(experiments).forEach(val => {
        ...
        val.lines.push(`Median time: ${getMedian(val.runtimes.random)}`)
        val.lines.push(`Median DPLL iterations: ${getMedian(val.DPLLCount.random)}`)
        val.lines.push("====================================================")
        val.lines.push("TWOCLAUSE RESULTS")
        val.lines.push(`Median time: ${getMedian(val.runtimes.twoClause)}`)
        val.lines.push(`Median DPLL iterations: ${getMedian(val.DPLLCount.twoClause)}`)
        val.lines.push("====================================================")
        ...
        val.lines.push("Random: ", val.timeouts.random)
        val.lines.push("TwoClause: ", val.timeouts.twoClause)
